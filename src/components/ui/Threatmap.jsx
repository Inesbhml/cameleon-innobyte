...
export const ThreatMap = () => {
    ...
    const totalAttacks = ATTACK_ORIGINS.reduce((a, o) => a + o.attacks, 0);
    const topSource = [...ATTACK_ORIGINS].sort((a, b) => b.attacks - a.attacks)[0];
        ...
        >
            ...
            >
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <span style={{ fontSize: 10, color: "#f87171", fontWeight: 500 }}>LIVE</span>
                </div>
            ...
            <div ref={wrapRef} style={{ position: "relative", background: "#080a0f", minHeight: 200 }}>
                ...
                >
                    ...
                    {/* Arc lines */}
                    {ready && project && targetPt && ATTACK_ORIGINS.map((o, i) => {
                    ...
                    {/* Origin dots */}
                    {ready && project && ATTACK_ORIGINS.map((o, i) => {
                        const pt = project(o.lat, o.lng);
                        if (!pt) return null;
                        const c = SEV_COLORS[o.severity];
                        const isH = hovered === i;
                            ...
                            >
                                ...
                                {isH && (
                                    <g>
                                        ...
                                        <text x={tipX + 10} y={tipY + 42} fontSize="8" fill="#6b7280" fontFamily="system-ui">{o.severity.toUpperCase()}</text>
                                    </g>
                                )}
                            </g>
                        );
            ...
            <div style={{
                ...
                {[
                    { label: "Origins", value: `${ATTACK_ORIGINS.length} countries`, color: "#fff" },
